...
<div class="modal fade" id="edit_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="edit_unloading.php">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="ustarttime" value="<?php echo $row['ustarttime']; ?>">
					</div>
				</div>
                ...
                <div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="uepfno" value="<?php echo $row['uepfno']; ?>">
					</div>
				</div>
...
<div class="modal fade" id="delete_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Cancel</button>
                <a href="delete_unloading.php?id=<?php echo $row['id']; ?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Yes</a>
            </div>
