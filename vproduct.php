...
<div class="sidebar close">
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="vproduct.php">Report QTY</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
  ...
  <section class="home-section">
    ...
    <div class="container">
	<h1 class="page-header text-center">Qty to Report Details </h1>
	...
	<div class="row">
        ...
        <a href="print_investory.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> PDF</a>
            ...
            <?php 
            $select_ifsno = mysqli_query($conn, "SELECT * FROM `base` WHERE ifsno = 'MOIU-82014' ") or die('query failed');
            $number_of_ifsno = mysqli_num_rows($select_ifsno);
         ?>         
            <th>Qty to Report</th> <?php echo $number_of_ifsno; ?>
          </thead>
          <tbody>
						<?php
