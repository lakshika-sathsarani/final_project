...
<div class="sidebar close">
    ...
    <ul class="nav-links">
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="loading.php">Loading</a></li>
        </ul>
      </li>
      <li>
        <a href="quality.php">
  ...
  <section class="home-section">
    ...
    <div class="container">
	<h1 class="page-header text-center">Loading Section-details</h1>
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<div class="row">
				<a href="#addnewLoading" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> New</a>
				<a href="print_loading.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> PDF</a>
			</div>
					...
					<tbody>
						<?php
                            ...
                            while($row = $query->fetch_assoc()){
                                ...
                                include('edit_delete_loading.php');
                            }
						?>
					</tbody>
				</table>
...
<?php include('add_model_loading.php') ?>
