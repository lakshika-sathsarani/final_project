...
<div class="sidebar close">
  ...
  <section class="home-section">
    ...
    <div class="container">
	<h1 class="page-header text-center">User Details </h1>
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<div class="row">
				<a href="#addnewUser" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> New</a>
				</div>
...
<?php include('add_model_user.php') ?>
