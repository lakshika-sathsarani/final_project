...
<div class="sidebar close">
  ...
  <section class="home-section">
    ...
    <div class="container">
	<h1 class="page-header text-center">Quality Section</h1>
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<div class="row">
				<a href="quality_model.php" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> New</a>
