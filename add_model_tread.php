<!-- Add New -->
<div class="modal fade" id="addnewTread" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="add_tread.php">
			...
			<div class="row form-group">
					...
					<select name="ifsno" class="form-control">
						...
						?>
						<form action="add_tread.php" method="post">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-10">
                      <select name="tepfno" class="form-control">
					  <option value="nal4563987">nal4563987</option>
                       <option value="mal4528745">mal4528745</option>
					   <option value="kal4563987">kal4563987</option>
                       <option value="lak4528745">lak4528745</option>
                     </select>
				  </div>
				</div>
