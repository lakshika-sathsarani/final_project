...
<body>
    ...
    <section class="home-section">
        ...
        <div class="container">
            <h1 class="page-header text-center">Molding Section-Details</h1>
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <div class="row">
                    <a href="print_moldings.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> PDF</a>
                </div>
