  ...
  <section class="home-section">
	...
	<div class="row">
		<div class="col-sm-8 col-sm-offset-2">
			...
			<div class="row">
				<a href="#addnewCushion" data-toggle="modal" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> New</a>
				<a href="print_cushion.php" class="btn btn-success pull-right"><span class="glyphicon glyphicon-print"></span> PDF</a>
			</div>
					...
					<tbody>
						<?php
                            ...
                            while($row = $query->fetch_assoc()){
                                ...
                                include('edit_delete_cushoin.php');
                            }
						?>
					</tbody>
				</table>
...
<?php include('add_model_cushion.php') ?>
