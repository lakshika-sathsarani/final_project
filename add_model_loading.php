<!-- Add New -->
<div class="modal fade" id="addnewLoading" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
			...
			<form method="POST" action="add_loading.php">
			...
			<div class="row form-group">
					...
					<select name="ifsno" class="form-control">
						...
						?>
						<form action="add_loading.php" method="post">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="datetime-local" class="form-control" name="lstarttime" required>
					</div>
				</div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-sm-10">
                      <select name="lepfno" class="form-control">
					  <option value="zal4563987">zal4563987</option>
                       <option value="oal4528745">oal4528745</option>
					   <option value="qal4563987">qal4563987</option>
                       <option value="ual4528745">ual4528745</option>
                     </select>
				  </div>
				</div>
